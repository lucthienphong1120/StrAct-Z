# 🧠 AI Coding Rules & Project Context - StrAct Z (v1.50.58)

This file serves as a persistent memory and rulebook for AI coding assistants working on the **StrAct Z** platform (v1.50.58). Follow these guidelines strictly.
