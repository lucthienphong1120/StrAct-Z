...
| **Garmin Forerunner 955** | 1 | 4024 | Fit OK |
...
| **Garmin Venu 2S** | 1 | 3704 | Fit OK |
| **Garmin Venu 2 Plus** | 1 | 3851 | Fit OK |
| **Garmin Venu Sq 2** | 1 | 4115 | Fit OK |
...
| **Suunto Race** | 23 | ? | Chưa test |
| **Suunto Ocean** | 23 | ? | Chưa test |
| **Suunto 9 Peak Pro** | 23 | ? | Chưa test |
| **Amazfit Bip 6** | 339 | ? | Chưa test |
| **Amazfit Cheetah** | 339 | ? | Chưa test |
| **Amazfit T-Rex 3** | 339 | ? | GPX OK |
| **Amazfit GTR 4** | 339 | ? | Chưa test |
| **Amazfit Balance 2** | 339 | ? | GPX OK |
| **Amazfit Active 2** | 339 | ? | Chưa test |
| **Amazfit Active 3 Premium** | 339 | ? | GPX OK |
| **Huawei Watch GT 6 Pro** | 348 | ? | GPX OK |
| **Huawei Watch GT 6** | 348 | ? | GPX OK |
| **Huawei Watch Fit 5 Pro** | 348 | ? | GPX OK |
| **Huawei Watch Fit 5** | 348 | ? | GPX OK |
| **Huawei Watch Fit 4 Pro** | 348 | ? | GPX OK |
| **Huawei Watch Fit 4** | 348 | ? | GPX OK |
| **Huawei Watch GT 5** | 348 | ? | GPX OK |
| **Huawei Watch GT 5 Pro** | 348 | ? | GPX OK |
| **Huawei Watch 5** | 348 | ? | GPX OK |
| **Huawei Watch D2** | 348 | ? | GPX OK |
| **Huawei Watch Ultimate 2** | 348 | ? | GPX OK |
| **Huawei Watch Kids** | 348 | ? | GPX OK |
...
```
Type: GPX
Source: Huawei Health / COROS
Description: Device name
```

Với thiết vị Suunto/Amazfit:
```
Type: GPX
Source: Device name
Description: 
...
* **Suunto (Manufacturer: 23)**
  * Product: `undefined` | Thiết bị: Vertical (nhận diện qua tên thiết bị)
