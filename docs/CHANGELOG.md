...
All notable changes to the **StrAct Z** platform are documented here.
...
### v1.50.39 (2026-05-12)
- **Google Fit Reliability**: Fixed Data Source naming convention to use a consistent `streamId` (`stract-z-sync`). This prevents hitting the limit on data sources and ensures Google Fit correctly aggregates the manual sync data.
