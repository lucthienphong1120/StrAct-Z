...
+ [x] tối ưu hóa độ chân thực GPX (độ cao tích lũy 1-5m, schema gpxtpx), metadata upload (sport type, description chỉ ghi tên thiết bị, creator luôn là Garmin Connect để có tag đồng bộ ở dưới), sửa vỡ responsive Avoid Workhours, và điều chỉnh trọng số quận (v1.51.50)
